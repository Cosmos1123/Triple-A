...
import Htet_Lithan.com.test.model.CustomerModel;
import Htet_Lithan.com.test.model.CustomerSoap;
...
/**
 * The base model implementation for the Customer service. Represents a row in the &quot;HS_Customer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link Htet_Lithan.com.test.model.CustomerModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CustomerImpl}.
 * </p>
 *
 * @author USER
 * @see CustomerImpl
 * @see Htet_Lithan.com.test.model.Customer
 * @see Htet_Lithan.com.test.model.CustomerModel
 * @generated
 */
@JSON(strict = true)
public class CustomerModelImpl extends BaseModelImpl<Customer>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a customer model instance should use the {@link Htet_Lithan.com.test.model.Customer} interface instead.
	 */
	public static final String TABLE_NAME = "HS_Customer";
	...
	public static final String TABLE_SQL_CREATE = "create table HS_Customer (uuid_ VARCHAR(75) null,customerId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,customerName VARCHAR(75) null,customerEmail VARCHAR(75) null,customerContact VARCHAR(75) null,customerAddress VARCHAR(75) null,payment VARCHAR(75) null,time_ DATE null,servicesId LONG)";
	public static final String TABLE_SQL_DROP = "drop table HS_Customer";
	public static final String ORDER_BY_JPQL = " ORDER BY customer.customerName DESC";
	public static final String ORDER_BY_SQL = " ORDER BY HS_Customer.customerName DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.Htet_Lithan.com.test.model.Customer"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.Htet_Lithan.com.test.model.Customer"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.Htet_Lithan.com.test.model.Customer"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.Htet_Lithan.com.test.model.Customer"));
	...
	public CacheModel<Customer> toCacheModel() {
		...
		if (time != null) {
			customerCacheModel.time = time.getTime();
		}
		else {
			customerCacheModel.time = Long.MIN_VALUE;
		}
